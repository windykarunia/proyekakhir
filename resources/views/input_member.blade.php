    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <li class="nav-item">
                ...
                <span class="menu-title">Daftar Peminjam</span>
                <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="tampil_pinjam">List Peminjam</a></li>
                    <li class="nav-item"><a class="nav-link" href="input_pinjam">Input Peminjam</a></li>
                </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="input_member">List Member</a></li>
                </ul>
                </div>
            </li>
            </ul>
