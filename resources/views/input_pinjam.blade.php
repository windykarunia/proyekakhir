    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <li class="nav-item">
                ...
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="tampil_pinjam">List Peminjam</a></li>
                    <li class="nav-item"><a class="nav-link" href="input_pinjam">Input Peminjaman</a></li>
                </ul>
                </div>
            </li>
            <li class="nav-item">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="{{url('kirim_pinjam')}}">
                    @csrf
                    ...
                    <a class="btn btn-danger" href="{{ url('tampil_pinjam') }}">Batal</a>
                  </form>
                </div>
              </div>
            </div>
